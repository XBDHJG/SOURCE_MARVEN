...
@app.on_message(filters.command(["اذكار", "الاذكار"], ""), group=666)
...
@app.on_message(filters.command(["تويت"], ""), group=4252)
...
@app.on_message(filters.command(["صراحه"], ""), group=7327)
...
@app.on_message(filters.command(["انصحني"], ""), group=9202)
...
@app.on_message(filters.command(["نكت"], ""), group=3673)
...
@app.on_message(filters.command(["احكام"], ""), group=666)
async def bottttt(client, message):
